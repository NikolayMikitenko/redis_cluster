...
App with ID = 1 calculate Random probability but it lower than decision, and data was taken from cache. 
...
App with ID = 3 get refreshed data by other app, and new data was taken from cache. 
